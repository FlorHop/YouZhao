...
var BaseStyle = {
  ...
  load: function load(style2) {
    ...
    return s2(computedStyle) ? useStyle(Y2(computedStyle), _objectSpread2({
      name: this.name
    }, options)) : {};
  },
  ...
  getThemeStyleSheet: function getThemeStyleSheet(params) {
    ...
    if (this.style) {
      ...
      var _style = Y2(S2.transformCSS(name, _css));
...
//# sourceMappingURL=chunk-FCWGF4AH.js.map
